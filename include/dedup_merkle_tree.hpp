...
//template<class Hasher, typename DataView>
//void deduplicate_data_largest_regions(DataView& data, 
...
//  Kokkos::UnorderedMap<HashDigest, Vector, Kokkos::DefaultExecutionSpace, digest_hash, digest_equal_to> dupl_map(num_nodes);
//
...
//      if(!first_ocur_dupl.exists(digest)) {
